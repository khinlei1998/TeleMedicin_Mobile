  ...
  render() {
    return (
      ...
      >
        ...
        >
          <Image
            source={require('../../assets/images/pages/news.png')}
            borderRadius={10}
            style={{
              width: scale(120),
              height: verticalScale(120),
...
export class CardNine2 extends Component<Props> {
  static defaultProps={
  ...
  render() {
    return (
      ...
      >
        ...
        >
          <Image
            source={require('../../assets/images/pages/promotion.png')}
            borderRadius={10}
            style={{
              width: scale(120),
              height: verticalScale(120),
...
export class CardTwelve extends Component<Props> {
  constructor(props) {
    super(props);
  }
    progressColor = step => {
